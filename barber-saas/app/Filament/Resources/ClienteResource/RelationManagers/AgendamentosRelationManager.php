...
class AgendamentosRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Agendamentos do Cliente';
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\Filter::make('futuros')
                    ->label('Apenas futuros')
                    ->query(fn (Builder $query): Builder => $query->futuros()),
                Tables\Filters\Filter::make('passados')
                    ->label('Apenas passados')
                    ->query(fn (Builder $query): Builder => $query->passados()),
            ])
            ->headerActions([
